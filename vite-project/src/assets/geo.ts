export const provinceDict: Record<string, string[]> = {
  ...
  "Bạc Liêu": ["Vĩnh Lợi", "Bạc Liêu", "Hòa Bình", "Giá Rai", "Phước Long", "Đông Hải", "Hồng Dân",],
  ...
  "Bến Tre": ["Giồng Trôm", "Bến Tre", "Châu Thành", "Ba Tri", "Mỏ Cày Nam", "Bình Đại", "Thạnh Phú", "Mỏ Cày Bắc", "Chợ Lách",],
  "Cao Bằng": ["Cao Bằng", "Trà Lĩnh"],
  "Cà Mau": ["Thới Bình", "Cà Mau", "Cái Nước", "Năm Căn", "Trần Văn Thời", "U Minh", "Đầm Dơi", "Phú Tân",],
  ...
  "Hà Giang": ["Mèo Vạc", "Quang Bình", "Hà Giang", "Bắc Quang", "Hoàng Su Phì", "Đồng Văn", "Vị Xuyên"],
  ...
  "Hậu Giang": ["Long Mỹ", "Châu Thành", "Ngã Bảy", "Vị Thanh", "Châu Thành A", "Phụng Hiệp", "Thị xã Long Mỹ", "Vị Thủy",],
  ...
  "Kiên Giang": ["Tân Hiệp", "Châu Thành", "Phú Quốc", "Rạch Giá", "Hà Tiên", "Kiên Hải", "An Biên", "Kiên Lương", "Hòn Đất", "Giồng Riềng", "Gò Quao", "Giang Thành",],
  ...
  "Phú Yên": ["Tây Hòa", "Tuy Hòa", "Đông Hòa", "Sông Cầu", "Phú Hòa", "Sơn Hòa", "Tuy An", "Sông Hinh", "Đồng Xuân",],
  ...
  "Sơn La": ["Quỳnh Nhai", "Mộc Châu", "Bắc Yên", "Sơn La", "Vân Hồ", "Phù Yên", "Sốp Cộp"],
  "Thanh Hóa": ["Quan Hóa", "Hoằng Hóa", "Nga Sơn", "Nghi Sơn", "Ngọc Lặc", "Nông Cống", "Sầm Sơn", "Thanh Hóa", "Thạch Thành", "Triệu Sơn", "Đông Sơn", "Bỉm Sơn", "Hà Trung", "Bá Thước", "Như Thanh", "Như Xuân", "Quảng Xương", "Thọ Xuân", "Yên Định", "Cẩm Thủy", "Hậu Lộc", "Lang Chánh", "Vĩnh Lộc", "Thiệu Hóa", "Thường Xuân",],
